...
const componentGenerator = {
  ...
  actions: (data) => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../src/api/{{camelCase routeName}}.js',
      ...
      {
        type: 'add',
        path: '../src/store/actions/{{camelCase routeName}}.js',
      ...
      {
        type: 'add',
        path: '../src/store/reducers/{{camelCase routeName}}.js',
      ...
      {
        type: 'add',
        path: '../src/store/sagas/{{camelCase routeName}}.js',
